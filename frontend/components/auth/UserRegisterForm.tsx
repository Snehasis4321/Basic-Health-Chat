...
export default function UserRegisterForm({ onSuccess, onError }: UserRegisterFormProps) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3001'}/api/auth/user/register`, {
        method: 'POST',
        headers: {
